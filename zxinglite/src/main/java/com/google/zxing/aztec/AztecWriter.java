...
public final class AztecWriter implements Writer {
  ...
  @Override
  public BitMatrix encode(String contents, ZBarcodeFormat format, int width, int height) {
    return encode(contents, format, width, height, null);
  }

  @Override
  public BitMatrix encode(String contents, ZBarcodeFormat format, int width, int height, Map<EncodeHintType,?> hints) {
  ...
  private static BitMatrix encode(String contents, ZBarcodeFormat format,
                                  int width, int height,
                                  Charset charset, int eccPercent, int layers) {
    if (format != ZBarcodeFormat.AZTEC) {
